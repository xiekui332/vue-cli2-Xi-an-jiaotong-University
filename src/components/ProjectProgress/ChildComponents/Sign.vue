        ...
        <div class="pl-info">
            ...
            <div class="st-item">
                <div class="st-item-header">
                    <span class="pub-family">资料填写(付款信息)</span>
                ...
                <div class="st-edit-content">
                    ...
                    <div class="st-edit-item st-oparate" v-for="(i, ind) in infoArr" :key="ind">
                        ...
                        <div class="st-oparate-col">
                            <el-input v-model="i.moneyVal" placeholder="请输入内容" type='number' :disabled='i.isEdit'></el-input>
                        </div>
                        <div class="st-oparate-col">
                            <el-input v-model="i.residueVal" placeholder="请输入内容" type='number' :disabled='i.isEdit'></el-input>
                        </div>
                        <div class="st-oparate-col">
                ...
                <div class="st-edit-content">
                    ...
                    <div class="st-edit-item">
                        <div class="st-icon-file-title">
                            ...
                            <span class="st-file-title"><i class="st-tips-required">*</i> 采购需求说明书(模板)</span>
                        </div>
            ...
            <el-row class="pl-finish">
                <el-button type="primary">完成本节点</el-button>
            </el-row>
            <p class="pl-finish-tip">完成后项目进入下一节点，本节点将不能编辑信息、上传资料。</p>
    </div>
</template>
